...
import React from 'react';
import { Card } from '@/components/ui/card';
import { Wind, Compass, Gauge, Waves, Mountain, ArrowUp, ArrowDown } from 'lucide-react';
import { CurrentWeatherResponse } from '@/types/weather';
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-muted/40 backdrop-blur-sm rounded-xl p-3 border border-border/20">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-lg font-bold text-foreground">
                    {windSpeed} <span className="text-sm font-normal">{windUnit}</span>
                  </span>
                </div>
              ...
              <div className="bg-muted/40 backdrop-blur-sm rounded-xl p-3 border border-border/20">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-lg font-bold text-foreground">{direction}</span>
                </div>
          ...
          >
            ...
            <div className="space-y-2">
              <div className="bg-muted/40 backdrop-blur-sm rounded-xl p-3 border border-border/20">
                ...
                <p className="text-xs text-muted-foreground mt-1">Surface Level</p>
              </div>
              ...
              {currentWeather.main.grnd_level && (
                <div className="bg-green-500/5 rounded-xl p-3 border border-green-500/20">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">Ground Level</p>
                </div>
              )}
            </div>
          </motion.div>
